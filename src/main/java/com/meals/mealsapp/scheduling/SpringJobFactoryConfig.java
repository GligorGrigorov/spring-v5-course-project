...
@Configuration
public class SpringJobFactoryConfig {

    private static final String QUARTZ_CONFIG_PATH = "/quartz.yml";
    ...
    public SimpleTriggerFactoryBean simpleJobTrigger(
            ...
            @Value("${updateMetricsJob.frequency}") long frequency) {
    ...
    public JobDetailFactoryBean simpleJobDetail() {
        ...
        factoryBean.setJobClass(UpdateMetricsJob.class);
